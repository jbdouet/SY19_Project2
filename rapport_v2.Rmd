...
On concluera donc d'avec un dataset avec si peu d'individus, il n'est possible d'appliquer que des méthodes de machine learning classiques, ne nécéssitant pasénormément de data.
Ce qui fera la différence sur le résultat pour un méthode donnée sont les étapes de preprocesing et feature engineering qui vise ici à réduire lenombre de features du dataset et à en extraire du sens (interprétation).
